...
function BPCharacterAdvancementMixin:OnLoad()
    self.classMasteries = {}
    ...
    self.CategoryPool = CreateFramePool("Frame", self.Content.ScrollChild.Spells, "BPCASpellCategoryTemplate")
    self.SpellPool = CreateFramePool("Button", self.Content.ScrollChild.Spells, "BPCASpellButtonTemplate")
    self.CompactSpellPool = CreateFramePool("Button", self.Content.ScrollChild.Spells, "BPCACompactSpellButtonTemplate")
    self.TalentPool = CreateFramePool("Button", self.Content.ScrollChild.Talents, "BPCATalentButtonTemplate")

    self.SpellClassIconsPool = CreateFramePool("Button", self.Content.ScrollChild.Spells, "BPCASummaryClassIconTemplate")
    self.TalentClassIconsPool = CreateFramePool("Button", self.Content.ScrollChild.Talents, "BPCASummaryClassIconTemplate")

    self.GateCounterSpells = CreateFramePool("Frame", self.Content.HeaderSpells, "BPCATalentGateCounterTemplate")
    self.GateCounterTalents = CreateFramePool("Frame", self.Content.HeaderTalents, "BPCATalentGateCounterTemplate")

    MixinAndLoadScripts(self.Content.ScrollChild.Talents, "BPCAConnectedNodesMixin")
    MixinAndLoadScripts(self.Content.ScrollChild.Talents, "BPCATalentFrameGatesMixin")
...
function BPCharacterAdvancementMixin:IsDraftMode()
    return self.mode == Enum.GameMode.Draft
end

function BPCharacterAdvancementMixin:IsWildCardMode()
    return self.mode == Enum.GameMode.WildCard
end

function BPCharacterAdvancementMixin:LockTalentsFrameCheck()
    if C_Player:IsHero() then
        return
    end
...
function BPCharacterAdvancementMixin:RegisterUpdateEvents()
...
function BPCharacterAdvancementMixin:UnregisterUpdateEvents()
...
function BPCharacterAdvancementMixin:OnShow()
...
function BPCharacterAdvancementMixin:OnHide()
...
function BPCharacterAdvancementMixin:ToggleWildCardRapidRolling()
...
function BPCharacterAdvancementMixin:ShowNormalFooter()
...
function BPCharacterAdvancementMixin:AddFakeLevelTooltip(item)
...
function BPCharacterAdvancementMixin:RefreshHeaderTotal()
...
function BPCharacterAdvancementMixin:ShowMaximizedFooter()
...
function BPCharacterAdvancementMixin:UpdateSpellListHeight()
...
function BPCharacterAdvancementMixin:TogglePrimaryStatPicker()
...
function BPCharacterAdvancementMixin:ShowPrimaryStatPicker()
    local header = self.SideBar.SpellList.Header
...
function BPCharacterAdvancementMixin:HidePrimaryStatPicker()
    local header = self.SideBar.SpellList.Header
...
function BPCharacterAdvancementMixin:ToggleRarityFlyout()
...
function BPCharacterAdvancementMixin:ShowRarityFlyout()
    if C_GameMode:IsGameModeActive(Enum.GameMode.Draft, Enum.GameMode.WildCard) then
        return
    end
...
function BPCharacterAdvancementMixin:HideRarityFlyout()
    local footer = self.SideBar.SpellList.Footer
...
function BPCharacterAdvancementMixin:SetSearch(text)
...
function BPCharacterAdvancementMixin:Search()
    local header = self.SideBar.SpellList.Header
...
function BPCharacterAdvancementMixin:BrowserSearch()
...
function BPCharacterAdvancementMixin:RemoveSpellTag(_, filter, tag)
    if filter then
...
function BPCharacterAdvancementMixin:ClearSearch()
    self:SetSearch("")
    self.Content.SearchBox:SetText("")
end

function BPCharacterAdvancementMixin:Locate(entry)
...
function BPCharacterAdvancementMixin:SelectSummary()
    C_CVar.Set("caLastSpec", "SUMMARY")
    self:FullUpdate()
end

function BPCharacterAdvancementMixin:SelectBrowser()
    C_CVar.Set("caLastClass", "BROWSER")
    self.Content:SelectTabID(SPELL_BROWSER_TAB)
end

function BPCharacterAdvancementMixin:SelectClassInNavigation(classFile)
...
function BPCharacterAdvancementMixin:SelectClass(classFile, specFile)
...
function BPCharacterAdvancementMixin:SelectSpec(tabID)
...
function BPCharacterAdvancementMixin:SetupClassButtons()
    ...
    if IsDefaultClass() then
        local class = C_Player:GetClass()
        local button = CreateFrame("Button", "$parentClassButton1", layoutFrame, "BPCAClassButtonTemplate")
    ...
    self.Navigation2.Browser = CreateFrame("Button", "$parentBrowser", layoutFrame, "BPCAClassButtonTemplate")
    ...
    for i = 1, #CHARACTER_ADVANCEMENT_CLASS_ORDER do  
        ...
        local button = CreateFrame("Button", "$parentClassButton"..i, layoutFrame, "BPCAClassButtonTemplate")
    ...
    self.Navigation2.Summary = CreateFrame("Button", "$parentSummary", layoutFrame, "BPCAClassButtonTemplate")
    ...
    --[[else
        ...
        if CharacterAdvancementUtil.CanUseBrowser() then
            ...
            for i = 1, #CHARACTER_ADVANCEMENT_CLASS_ORDER do  
                local class = CHARACTER_ADVANCEMENT_CLASS_ORDER[i]
                local button = CreateFrame("Button", "$parentClassButton"..i, self.Navigation2, "BPCAClassButtonTemplate")
...
function BPCharacterAdvancementMixin:UpdateBrowserButtonVisibility()
...
function BPCharacterAdvancementMixin:ShowBrowserTabs()
    self:ShowClassTabs()
...
function BPCharacterAdvancementMixin:ShowClassTabs()
...
function BPCharacterAdvancementMixin:SetupSpecTabs()
    MixinAndLoadScripts(self.Content, "TabSystemMixin")
    self.Content:SetTabTemplate("BPCASpecTabTemplate")
...
function BPCharacterAdvancementMixin:OnSpecTabSelected(tabID)
...
function BPCharacterAdvancementMixin:SetupSideBarTabs()
...
function BPCharacterAdvancementMixin:CanShowPrimaryStat()
    return C_Player:IsHero() and not(C_GameMode:IsGameModeActive(Enum.GameMode.BuildDraft))
end

function BPCharacterAdvancementMixin:RefreshPrimaryStats() -- primary stat can be updated from outside. Load actual known info on :Refresh()
    local canChoosePrimaryStat = self:CanShowPrimaryStat()
    local header = self.SideBar.SpellList.Header
...
function BPCharacterAdvancementMixin:RefreshCurrencies()
...
function BPCharacterAdvancementMixin:RefreshSaveChangesButton()
...
function BPCharacterAdvancementMixin:OnClickUndoChanges()
    PlaySound("gsCharacterCreationCancel")
    CharacterAdvancementUtil.MarkForSwap(nil)
    C_CharacterAdvancement.CancelPendingBuild()
end

function BPCharacterAdvancementMixin:OnClickSaveChanges()
    CharacterAdvancementUtil.ConfirmApplyPendingBuild()
end

function BPCharacterAdvancementMixin:RefreshClassButtons()
...
function BPCharacterAdvancementMixin:Refresh(dontRefreshHeader)
    self.GateCounterSpells:ReleaseAll()
    self.GateCounterTalents:ReleaseAll()
...
function BPCharacterAdvancementMixin:ForceUpdateRarityFlyout()
...
function BPCharacterAdvancementMixin:ClearTalentGates()
    self.GateCounterSpells:ReleaseAll()
    self.GateCounterTalents:ReleaseAll()
...
function BPCharacterAdvancementMixin:RefreshGateInfo(class, spec, hardReset)
...
function BPCharacterAdvancementMixin:FullUpdate(dontSearch)
    --dprint("BPCharacterAdvancementMixin:FullUpdate")
    self:Refresh(true)
...
function BPCharacterAdvancementMixin:SetSpells(class, spec)
...
function BPCharacterAdvancementMixin:SetMasteriesAndTraits(classFile)
    local class = CharacterAdvancementUtil.GetClassDBCByFile(classFile)
...
function BPCharacterAdvancementMixin:SetTalents(class, spec)
...
function BPCharacterAdvancementMixin:SetSpellSummary()
...
function BPCharacterAdvancementMixin:SetTalentSummary()
    local height = self.Content:GetHeight()
...
function BPCharacterAdvancementMixin:InitializeSpellDropDown(dropdown, level, menuList)
...
function BPCharacterAdvancementMixin:ShowSpellDropDownMenu(spellButton, relativeRegion)
...
function BPCharacterAdvancementMixin:PlayAnimationForToken(tokenType, specID, count)
...
function BPCharacterAdvancementMixin:UpdateContentScrollLayout(maxOffset)
    local specFile = C_CVar.Get("caLastSpec")
...
function BPCharacterAdvancementMixin:ContentOnScrollRangeChanged(xrange, yrange)
...
function BPCharacterAdvancementMixin:FindLocateButton(entryID)
    if not entryID then
        return nil
    end
...
function BPCharacterAdvancementMixin:ScrollToLocate()
...
function BPCharacterAdvancementMixin:CHARACTER_ADVANCEMENT_PENDING_BUILD_UPDATED()
...
function BPCharacterAdvancementMixin:WILDCARD_ENTRY_LEARNED()
...
function BPCharacterAdvancementMixin:ASCENSION_CA_SPECIALIZATION_ACTIVE_ID_CHANGED(specID)
    if self:IsShown() then
        self:FullUpdate()
    end
end 

function BPCharacterAdvancementMixin:PET_TALENT_UPDATE()
    self:Refresh()
end

function BPCharacterAdvancementMixin:PLAYER_REGEN_DISABLED()
    self:FullUpdate()
end

function BPCharacterAdvancementMixin:PLAYER_REGEN_ENABLED()
    self:FullUpdate()
end

function BPCharacterAdvancementMixin:PLAYER_LEVEL_UP()
    self:FullUpdate()
    self:RefreshCurrencies()
end 

function BPCharacterAdvancementMixin:TOKEN_UPDATED()
    self.SideBar.SpecList:RefreshScrollFrame()
    self.SideBar.SpellList.Footer.RarityCurrencyBar:Update()
end

function BPCharacterAdvancementMixin:CHARACTER_ADVANCEMENT_BUILD_LEVEL_UPDATED()
    -- currency bars update themselves
    self:RefreshCurrencies()
end 

function BPCharacterAdvancementMixin:CURRENCY_DISPLAY_UPDATE()
    -- currency bars update themselves
    self:RefreshCurrencies()
end 

function BPCharacterAdvancementMixin:CHARACTER_ADVANCEMENT_SUGGESTIONS_UPDATED()
    if self.Content.AbilityBrowser:IsVisible() then
        self:BrowserSearch()
    end
end

function BPCharacterAdvancementMixin:SPELL_TAGS_CHANGED()
    self:CHARACTER_ADVANCEMENT_PENDING_BUILD_UPDATED()
end

function BPCharacterAdvancementMixin:SPELL_TAG_TYPES_CHANGED()
...
function BPCharacterAdvancementMixin:STAT_SUGGESTIONS_UPDATED()
    if ShowForcedPrimaryStat(false) then
        ForcedPrimaryStatFrame:CheckSuggestions()
    end
end

function BPCharacterAdvancementMixin:CHARACTER_ADVANCEMENT_LEARN_RESULT(success, result, entryID, rank)
    if success then
        return
    end
...
function BPCharacterAdvancementMixin:CHARACTER_ADVANCEMENT_UNLEARN_RESULT(success, result, entryID)
    if success then
        return
    end
...
function BPCharacterAdvancementMixin:CHARACTER_ADVANCEMENT_PURGE_ABILITIES_RESULT(success, result)
    if success then
        return
    end
...
function BPCharacterAdvancementMixin:CHARACTER_ADVANCEMENT_PURGE_TALENTS_RESULT(success, result)
    if success then
        return
    end
...
function BPCharacterAdvancementMixin:CHARACTER_ADVANCEMENT_UPDATE_ENTRIES_RESULT(success, result, traversalResult, entryID, rank)
    if success then
        return
    end
