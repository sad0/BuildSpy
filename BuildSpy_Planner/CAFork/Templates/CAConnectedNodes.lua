...
BPCAConnectedNodesMixin = {}

function BPCAConnectedNodesMixin:OnLoad()
    self.ConnectedNodes = {}
    self.NodeMap = {}
    self.FilledNodes = {}
    self.LinePool = CreateFramePool("Frame", self, "BPCATalentBranchTemplate", ResetBranchNode)
end

function BPCAConnectedNodesMixin:DebugConnectedNodes()
...
function BPCAConnectedNodesMixin:CanMakeHorizontalConnection(startColumn, endColumn, row)
...
function BPCAConnectedNodesMixin:CanMakeVerticalConnection(startRow, endRow, column)
...
function BPCAConnectedNodesMixin:GetConnectionOrder(startColumn, startRow, endColumn, endRow)
    local order = {}
...
function BPCAConnectedNodesMixin:DrawConnectedNodes()
